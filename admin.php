...
<script>
  // Data for Highest Selling Products chart
  var productsData = {
    labels: [
  ...
  // Data for Recently Added Products chart
  ...
  window.addEventListener('DOMContentLoaded', (event) => {
    ...
    new Chart(productsChartCtx, productsChartConfig);

    var recentProductsChartCtx = document.getElementById('recentProductsChart').getContext('2d');
    new Chart(recentProductsChartCtx, recentProductsChartConfig);
  });
</script>
 <div class="col-md-4">
    <div class="panel panel-default">
